...
I wrote a blog post on Medium a while ago ([here](https://medium.com/@SaintDako/a-very-brief-introduction-to-unity-2d-e2b0d6ba7aec)), doing a brief introduction to Unity 2D. I was planning on doing multiple parts to that tutorial, but Ire never went through with it. Let's try again!
